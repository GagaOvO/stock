                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('store_location') ? ' has-error' : '' }}">
                            <label for="store_location" class="col-md-4 control-label">Store Location</label>

                            <div class="col-md-6">
                                <input id="store_location" type="text" class="form-control" name="store_location" required>
